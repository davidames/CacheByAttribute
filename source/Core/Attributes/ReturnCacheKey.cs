...
namespace CacheByAttribute
{
    ...
    public sealed class ReturnCacheKeyAttribute : OnMethodBoundaryAspect
    {


        /// <summary>
        /// For Testing Cache Key Generation: Returns the generated cache key.  Methods using this method will never be executed
        /// </summary>

        public ReturnCacheKeyAttribute()
        {
        ...
        /// For Testing Cache Key Generation: Returns the generated cache key.  Methods using this method will never be executed
        /// </summary>
        /// <param name="keyPrefix">The prefix for the cache key. If not specified, namespace.class.method will be used as a prefix for cache keys, with the parameter signature used for the rest of the key.</param>
   
        public ReturnCacheKeyAttribute(string keyPrefix)
        {
            KeyPrefix = keyPrefix;
        }
        ...
        /// </summary>
        public string AbsoluteKey { get; private set; }
        /// <summary>
